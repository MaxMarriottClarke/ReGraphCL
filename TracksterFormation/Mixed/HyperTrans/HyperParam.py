...
data_train = CCV1(ipath, max_events=30000)
data_val = CCV1(vpath, max_events=7000, inp = 'val')
...
output_dir = '/vols/cms/mm1221/hgcal/Mixed/LC/HyperTrans/results/'
result_path = (
...
for epoch in range(args.epochs):
    ...
    train_loss = train_new(train_loader, model, optimizer, args.k_value, device)
    val_loss = test_new(val_loader, model, args.k_value, device)
