...
data_val = CCV1(vpath, max_events=40000, inp='val')
...
output_dir = '/vols/cms/mm1221/hgcal/Mixed/LC/NT/runs/hd128nl3cd128k48_2/'
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

# (Optionally, you could load a pretrained model here if needed.)
# (Optionally, you could load a pretrained model here if needed.)
checkpoint_path = '/vols/cms/mm1221/hgcal/Mixed/LC/NegativeMining/runs/hd128nl3cd128k24/epoch-80.pt'
...
for epoch in range(epochs):
    ...
    train_loss = train_new(train_loader, model, optimizer, device, alpha)
    val_loss = test_new(val_loader, model, device, alpha = alpha2)
