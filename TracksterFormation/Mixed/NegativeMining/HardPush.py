...
output_dir = '/vols/cms/mm1221/hgcal/Mixed/LC/NegativeMining/runs/DEC/hd128nl3cd128k48/'
...
for epoch in range(epochs):
    ...
    if epoch < 20:
        ...
        alpha = (epoch - 40) / 40.0  # Linearly increase from 0 to 1
        alpha2 = (epoch - 40) / 40.0  # Linearly increase from 0 to 1
    else:
        alpha = 1
        alpha2 = 1
