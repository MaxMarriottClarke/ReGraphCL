...
data_train = CCV1(ipath, max_events=15000, inp = 'train')
...
output_dir = '/vols/cms/mm1221/hgcal/CLe/Hyper/results/Layer6Complex/'
...
for epoch in range(args.epochs):
    ...
    train_loss = train(train_loader, model, optimizer, device, args.temperature)
    val_loss = test(val_loader, model, device, args.temperature)
...
v_path = '/vols/cms/mm1221/Data/2e/test/raw/test.root'
