...
contrastive_dim=$6
heads=$7
epochs=150  # Set the number of epochs (or you can pass this as a parameter)

# Call the hyperparam.py script with the passed hyperparameters
python HyperParam.py --lr $lr --batch_size $batch_size --hidden_dim $hidden_dim --k_value $k_value --temperature $temperature --contrastive_dim $contrastive_dim --heads $heads --epochs $epochs
