...
data_train = CCV1(ipath, max_events=40000, inp='train')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--k_value", type=int, default=32,help="k")
    ...
    # Output directory
    parser.add_argument("--output_dir", type=str, default="/vols/cms/mm1221/hgcal/Mixed/Track/NegativeMining/runs/SEC/New/", help="Output directory for saving results")
