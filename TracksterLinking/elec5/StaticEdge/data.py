    ...
    def fill_data(self, max_events):
        ...
        for path in tqdm.tqdm(self.raw_paths):
            ...
            for array in uproot.iterate(
                ...
                tmp_raw_energy = tmp_raw_energy[mask]
                tmp_bx = tmp_bx[mask]
                tmp_by = tmp_by[mask]
                tmp_bz = tmp_bz[mask]
                tmp_beta = tmp_beta[mask]
                tmp_bphi = tmp_bphi[mask]
                tmp_EV1 = tmp_EV1[mask]
                tmp_EV2 = tmp_EV2[mask]
                tmp_EV3 = tmp_EV3[mask]
                tmp_eV0x = tmp_eV0x[mask]
                tmp_eV0y = tmp_eV0y[mask]
                tmp_eV0z = tmp_eV0z[mask]
                tmp_sigma1 = tmp_sigma1[mask]
                tmp_sigma2 = tmp_sigma2[mask]
                tmp_sigma3 = tmp_sigma3[mask]
