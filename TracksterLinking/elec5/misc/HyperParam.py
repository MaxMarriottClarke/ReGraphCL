...
model = Net(hidden_dim=args.hidden_dim, num_layers=args.num_layers, dropout=0.3, contrastive_dim=args.contrastive_dim).to(device)
...
output_dir = '/vols/cms/mm1221/hgcal/elec5New/Track/misc/results/ReLU/'
result_path = (
...
for epoch in range(args.epochs):
    ...
    train_loss = train_new(train_loader, model, optimizer, device, k_value=args.k_value, temp=args.temperature, alpha=alpha)
    val_loss = test_new(val_loader, model, device, k_value=args.k_value, temp=args.temperature)
