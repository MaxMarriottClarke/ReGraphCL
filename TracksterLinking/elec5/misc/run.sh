...
contrastive_dim=$6
k_value=$7
epochs=15  # Set the number of epochs (or you can pass this as a parameter)

# Call the hyperparam.py script with the passed hyperparameters
python HyperParam.py --lr $lr --batch_size $batch_size --hidden_dim $hidden_dim --num_layers $num_layers --temperature $temperature --contrastive_dim $contrastive_dim --k_value $k_value --epochs $epochs