...
def main():
    ...
    parser.add_argument(
        '--layer_types',
        type=str,
        default='edge,gat,edge',
        help='Comma-separated list of layer types. E.g. "edge,gat,edge"'
    )
    
    
    args = parser.parse_args()
    
    layer_types_list = args.layer_types.split(',')
    ...
    output_dir_base = '/vols/cms/mm1221/hgcal/TrackPi/StaticEdge/results/init/'
    result_path = (
