...
def main():
    ...
    parser.add_argument('--k_value', type=int, default=12, help='Number of nearest neighbors')
    ...
    train_loader = DataLoader(data_train, batch_size=1, shuffle=True, follow_batch=['x'])
    ...
    output_dir_base = '/vols/cms/mm1221/hgcal/TrackPi/Transformer/results/init/'
    result_path = (
    ...
    for i, data in enumerate(test_loader):
        ...
        with torch.no_grad():
            ...
            predictions = best_model(data.x, edge_index, 1)
    ...
    if os.path.exists(final_result_path):
        ...
        hyper_results_df = pd.DataFrame(columns=[
            ...
            'k_value', 'contrastive_dim', 'best_val_loss', 'purity', 'efficiency'
        ])
