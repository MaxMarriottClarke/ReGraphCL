...
if __name__ == '__main__':
    ...
    parser.add_argument("--contrastive_dim", type=int, default=16, help="Contrastive dimension")
    ...
    # Output directory
    parser.add_argument("--output_dir", type=str, default="/vols/cms/mm1221/hgcal/pion5New/Track/NegativeMining/runs", help="Output directory for saving results")
