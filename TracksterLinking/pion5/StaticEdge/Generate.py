...
learning_rates = [0.0001]   # 3 options
batch_sizes = [32, 64]                    # 2 options
hidden_dims = [64, 128]                   # Reduced from 3 to 2 options
k_neighbors = [8, 12, 16]                     # Reduced from 3 to 2 options
contrastive_dims = [8, 128]               # Reduced from 3 to 2 options

# New hyperparameters
num_layers = [2,3,4]                        # Reduced from 3 to 2 options
