...
#checkpoint= torch.load('/vols/cms/mm1221/hgcal/Mixed/LC/Full/runs/Trans/hd128nl3cd16nh4k32_25/best_model.pt',  map_location=torch.device('cpu'))
...
df_CL.to_csv('df_DEC_e_res.csv', index=False)
